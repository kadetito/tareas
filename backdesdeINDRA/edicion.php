...
<div class="card mb-4">
									<div class="card-block">
										<h3 class="card-title"><?=$TEXT_EditarProyectos;?></h3>
										...
										<h6 class="card-subtitle mb-2 text-muted"><?=$TXT_AquiPuedeEditarProyectosDePruebas;?></h6>
			...
			echo '<div class="row">';
				...
				recuperarArray($path,$lengua,$getId,$recup,$valor);
				echo '</div>';
			echo '</div>';
			?>	
										
			</form>				
			<?php guardarMasivoProyecto($path,$lengua,$getId);?>					
