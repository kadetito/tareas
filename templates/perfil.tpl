...
<meta http-equiv="Content-type" content="text/html; charset=utf-8" />
	...
	<title>PERFIL - TestBuild ({$version}) - {$nombre_proyecto}</title>
	  ...
	  <div class="card-block p-3 ">
		<div class="row">
				 <div class="col-md-12">
						...
						<p>Foto</p>
						<p><strong>Nombre:</strong>	{$perfil_nombre_usuario}</p> 
				...
				<div class="row">
				 <div class="col-md-12">
						...
						<p><strong>Fecha de alta:</strong>	<span class="float-right">{$D_fecha_prevista}</span></p>
						<p><strong>Fecha Actuali:</strong>	<span class="float-right">{$D_fecha_actualizacion}</span></p>
