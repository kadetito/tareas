	...
	<div class="container">
		...
		<section>
				...
				<div class="row">
					...
					<div class="col-sm-3 text-right resbus">
					    ...
					    <select name="filtrado_proyectos" class="form-control" onchange="this.form.submit()">
					       ...
					       <option value="Open">{$TXT_FORM_Open}</option>
					       <option value="Closed">{$TXT_FORM_Closed}</option>
					       <option value="en desarrollo">{$TXT_FORM_endesarrollo}</option>
					       <option value="test">{$TXT_FORM_test}</option>
					       <option value="resuelta">{$TXT_FORM_resuelta}</option>
					       <option value="reabierta">{$TXT_FORM_reabierta}</option>
					       <option value="abierta">{$TXT_FORM_abierta}</option>
					       <option value="cerrada">{$TXT_FORM_cerrada}</option>
...
<div class="row cambiosizefont">				
	<div class="col-md-3 mt-0">
	  <div class="row"><div class="col-md-12 scrollcolumna">{$listado_issues_lateral}</div></div>
  </div>
