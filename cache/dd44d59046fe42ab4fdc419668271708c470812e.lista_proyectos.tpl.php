...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c0044ff9b3de3_36138905',
...
function content_5c0044ff9b3de3_36138905 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
/favicon.ico">
	<title>LISTA PROYECTOS - TestBuild () - </title>
				...
				<div class="row">
					...
					<div class="col-sm-4 text-right resbus">
					    ...
					    <select name="filtrado_proyectos" class="form-control" onchange="this.form.submit()">
					       ...
					       <option value="Open"><?php echo $_smarty_tpl->tpl_vars['TXT_FORM_Open']->value;?>
</option>
					       <option value="Closed"><?php echo $_smarty_tpl->tpl_vars['TXT_FORM_Closed']->value;?>
</option>
					       <option value="en desarrollo"><?php echo $_smarty_tpl->tpl_vars['TXT_FORM_endesarrollo']->value;?>
</option>
					       <option value="test"><?php echo $_smarty_tpl->tpl_vars['TXT_FORM_test']->value;?>
</option>
					       <option value="resuelta"><?php echo $_smarty_tpl->tpl_vars['TXT_FORM_resuelta']->value;?>
</option>
					       <option value="reabierta"><?php echo $_smarty_tpl->tpl_vars['TXT_FORM_reabierta']->value;?>
</option>
					       <option value="abierta"><?php echo $_smarty_tpl->tpl_vars['TXT_FORM_abierta']->value;?>
</option>
					       <option value="cerrada"><?php echo $_smarty_tpl->tpl_vars['TXT_FORM_cerrada']->value;?>
</option>
...
<div class="row cambiosizefont">				
	<div class="col-md-12 mt-0">
	  <div class="row"><div class="col-md-12"><?php echo $_smarty_tpl->tpl_vars['listado_proyectos']->value;?>
</div></div>
  </div>
</div>
...
<div class="row">				
	<div class="col-md-12 mt-0 text-center">
	  <?php echo $_smarty_tpl->tpl_vars['paginationCtrlsProyectos']->value;?>
